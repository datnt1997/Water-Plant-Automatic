...
public class LibraryAdapter extends RecyclerView.Adapter<LibraryAdapter.MyViewHolder> {
    ...
    public LibraryAdapter(Context mContext, List<Plan> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        Plan plan = albumList.get(position);
        holder.title.setText(plan.getName());
        holder.count.setText(plan.getType() + " songs");

        // loading album cover using Glide library
        Glide.with(mContext).load(plan.getThumbnail()).into(holder.thumbnail);
